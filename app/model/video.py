...
VideoType.movie.label = '電影'
VideoType.cartoon.label = '動畫'
VideoType.episode.label = '影集'
VideoType.variety.label = '綜藝'
...
NationalityType.china.label = '台灣'
NationalityType.japan.label = '日本'
NationalityType.korea.label = '韓國'
NationalityType.america.label = '美國'
...
IdentityType.director.label = '導演'
